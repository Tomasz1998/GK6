		...
		for(int i = 1; i <= size; i++)
			{
				...
				gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT, materials[i], 5);
				gl2.glVertex3f((float) (rad * Math.cos(kat)), -2.0f, (float) (rad * Math.sin(kat)));		
				gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT, materials[i], 6);
				gl2.glVertex3f(0.0f, 5.0f, 0.0f);
				kat = i * (2 * Math.PI / size);
				gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT, materials[i], 7);
				gl2.glVertex3f((float) (rad * Math.cos(kat)), -2.0f, (float) (rad * Math.sin(kat)));
				gl2.glEnd();
